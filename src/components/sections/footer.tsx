      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex gap-5">
            <a
              ...
              aria-label="Follow ETH Phoenix on X"
            >
            ...
            <a
              href="https://t.me/ETHPhoenix"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground"
              aria-label="Join ETH Phoenix on Telegram"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground"
              aria-label="Follow ETH Phoenix on Instagram"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-10 border-t border-border/30 pt-6">
          <p className="text-xs text-muted-foreground/60">
            &copy; 2026 ETH Phoenix. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
